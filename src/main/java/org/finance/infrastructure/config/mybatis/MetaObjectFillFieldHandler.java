...
public class MetaObjectFillFieldHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        this.strictInsertFill(metaObject, "customerId", SecurityUtil::getProxyCustomerId, Long.class);
        this.strictInsertFill(metaObject, "customerNumber", SecurityUtil::getProxyCustomerNumber, String.class);
    }
